...
List<ConditionTagClass> initConditionTagList = [
  ConditionTagClass(id: '최상', text: '최상'.tr(), colorName: '청록색'),
  ConditionTagClass(id: '좋음', text: '좋음'.tr(), colorName: '청록색'),
  ConditionTagClass(id: '보통', text: '보통'.tr(), colorName: '청록색'),
  ConditionTagClass(id: '나쁨', text: '나쁨'.tr(), colorName: '청록색'),
  ConditionTagClass(id: '최악', text: '최악'.tr(), colorName: '청록색'),
  ConditionTagClass(id: '꿀잠', text: '꿀잠'.tr(), colorName: '파란색'),
  ConditionTagClass(id: '늦잠', text: '늦잠'.tr(), colorName: '파란색'),
  ConditionTagClass(id: '상쾌', text: '상쾌'.tr(), colorName: '파란색'),
  ConditionTagClass(id: '폭식', text: '폭식'.tr(), colorName: '파란색'),
  ConditionTagClass(id: '슬픔', text: '슬픔'.tr(), colorName: '파란색'),
  ConditionTagClass(id: '생리', text: '생리'.tr(), colorName: '파란색'),
  ConditionTagClass(id: '감기', text: '감기'.tr(), colorName: '빨간색'),
  ConditionTagClass(id: '스트레스', text: '스트레스'.tr(), colorName: '빨간색'),
  ConditionTagClass(id: '두통', text: '두통'.tr(), colorName: '빨간색'),
  ConditionTagClass(id: '살찜', text: '살찜'.tr(), colorName: '빨간색'),
  ConditionTagClass(id: '증량', text: '증량'.tr(), colorName: '보라색'),
  ConditionTagClass(id: '체함', text: '체함'.tr(), colorName: '보라색'),
  ConditionTagClass(id: '설사', text: '설사'.tr(), colorName: '보라색'),
  ConditionTagClass(id: '변비', text: '변비'.tr(), colorName: '보라색'),
];
